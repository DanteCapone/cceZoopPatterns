...
write.csv(final_data_s1,here(paste0("data/predicted_og/predicted_og_coi_",current_date,"_s1_phy_all_and_subpools.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s2,here(paste0("data/predicted_og/predicted_og_coi_",current_date,"_s2_phy_all_and_subpools.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s3,here(paste0("data/predicted_og/predicted_og_coi_",current_date,"_s3_phy_all_and_subpools.csv")))
