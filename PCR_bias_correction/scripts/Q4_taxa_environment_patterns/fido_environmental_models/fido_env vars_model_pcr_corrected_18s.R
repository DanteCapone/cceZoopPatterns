#Script to loop through different environmental variables and compare against taxa from PCR correction analysis
...
# Modify the data to combine coord and size, filter to only yhe 50% credible interval
