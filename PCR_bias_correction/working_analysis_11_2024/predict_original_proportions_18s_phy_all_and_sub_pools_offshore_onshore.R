...
##First Size 1
#Phyloseq Filtered
fido_input_filt=read.csv(here("PCR_bias_correction/data/fido/phy/fido_18s_s1_ecdf_family_phy_all_subpools_offshore.csv"), header=TRUE, check.names = FALSE, row.names = 1) %>%
...
write.csv(final_data_s1,here(paste0("PCR_bias_correction/data/predicted_og/predicted_og_18s_s1_phy_all_and_subpools_offshore.csv")))
...
############First 0.5-1############
#Phyloseq Filtered
fido_input_filt=read.csv(here("PCR_bias_correction/data/fido/phy/fido_18s_s2_ecdf_family_phy_all_subpools_offshore.csv"), header=TRUE, check.names = FALSE, row.names = 1) %>%
  column_to_rownames("Family")
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s2,here(paste0("PCR_bias_correction/data/predicted_og/predicted_og_18s_s2_phy_all_and_subpools_offshore.csv")))
...
##### 1-2mm####
#Phyloseq Filtered
fido_input_filt=read.csv(here("PCR_bias_correction/data/fido/phy/fido_18s_s3_ecdf_family_phy_all_subpools_offshore.csv"), header=TRUE, check.names = FALSE, row.names = 1) %>%
  column_to_rownames("Family")
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s3,here(paste0("PCR_bias_correction/data/predicted_og/predicted_og_18s_s3_phy_all_and_subpools_offshore.csv")))
...
##First Size 1
#Phyloseq Filtered
fido_input_filt=read.csv(here("PCR_bias_correction/data/fido/phy/fido_18s_s1_ecdf_family_phy_all_subpools_onshore.csv"), header=TRUE, check.names = FALSE, row.names = 1) %>%
  column_to_rownames("Family")
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s1,here(paste0("PCR_bias_correction/data/predicted_og/predicted_og_18s_s1_phy_all_and_subpools_onshore.csv")))
...
############First 0.5-1############
#Phyloseq Filtered
fido_input_filt=read.csv(here("PCR_bias_correction/data/fido/phy/fido_18s_s2_ecdf_family_phy_all_subpools_onshore.csv"), header=TRUE, check.names = FALSE, row.names = 1) %>%
  column_to_rownames("Family")
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s2,here(paste0("PCR_bias_correction/data/predicted_og/predicted_og_18s_s2_phy_all_and_subpools_onshore.csv")))
...
##### 1-2mm####
#Phyloseq Filtered
fido_input_filt=read.csv(here("PCR_bias_correction/data/fido/phy/fido_18s_s3_ecdf_family_phy_all_subpools_onshore.csv"), header=TRUE, check.names = FALSE, row.names = 1) %>%
  column_to_rownames("Family")
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s3,here(paste0("PCR_bias_correction/data/predicted_og/predicted_og_18s_s3_phy_all_and_subpools_onshore.csv")))
