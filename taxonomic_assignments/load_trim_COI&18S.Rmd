...
```{r read data}
MZG_18S <- readFASTA("~/Documents/databases/MetaZooGene26Oct2022/MZGfasta-18s__MZGdbALL__o00__A_withCCESeqs.fasta")
MZG_COI <- readFASTA("~/Documents/databases/MetaZooGene26Oct2022/MZGfasta-coi__MZGdbALL__o00__A_withCCESeqs.fasta")
...
write.dna(MZG_18S_zhan, file = '~/Documents/databases/MetaZooGene26Oct2022/ZHAN_18S_MetaZooGene_lower.fasta', format = 'fasta', colsep = "")
...
awk 'BEGIN{FS=" "}{if(!/>/){print toupper($0)}else{print $1}}' ZHAN_18S_MetaZooGene_lower.fasta > ZHAN_18S_MetaZooGene.fasta 
