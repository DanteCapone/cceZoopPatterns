...
write.csv(taxcoi_genus,here("data/phyloseq_bio_data/COI/sub_pools/fido_coi_genus_tax_table_a1_a3.csv"))
...
#Save
write.csv(fido_coi_s1_save_taxa_phy,here("data/fido/phy/sub_pools/fido_coi_s1_ecdf_taxa_phy_a1_a3.csv"))
write.csv(fido_coi_s1_save_hash_phy,here("data/fido/phy/sub_pools/fido_coi_s1_ecdf_hash_phy_a1_a3.csv"))
...
#Save
write.csv(fido_coi_s2_save_taxa_phy,here("data/fido/phy/sub_pools/fido_coi_s2_ecdf_taxa_phy_a1_a3.csv"))
write.csv(fido_coi_s2_save_hash_phy,here("data/fido/phy/sub_pools/fido_coi_s2_ecdf_hash_phy_a1_a3.csv"))
...
#Save
#Save
write.csv(fido_coi_s3_save_taxa_phy,here("data/fido/phy/sub_pools/fido_coi_s3_ecdf_taxa_phy_a1_a3.csv"))
# write.csv(fido_coi_s3_save_hash_phy,here("data/fido/phy/sub_pools/fido_coi_s3_ecdf_hash_phy_a1_a3.csv"))
