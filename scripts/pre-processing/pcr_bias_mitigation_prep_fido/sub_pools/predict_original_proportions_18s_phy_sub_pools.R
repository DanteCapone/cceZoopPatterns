...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s2,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s2_phy_a1_a3.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s3,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s3_phy_a1_a3.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s1,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s1_phy_b3_b5.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s2,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s2_phy_b3_b5.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s3,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s3_phy_b3_b5.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s1,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s1_phy_c5_c7.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s2,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s2_phy_c5_c7.csv")))
...
#Save final data
current_date <- format(Sys.Date(), "%m_%d_%Y")
write.csv(final_data_s3,here(paste0("data/predicted_og/sub_pools/predicted_og_18s_",current_date,"_s3_phy_c5_c7.csv")))
